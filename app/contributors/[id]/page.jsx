        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="p-8 mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <a
                  href={`mailto:${contributor.contact.email}`}
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href={`tel:${contributor.contact.phone}`}
                  className="text-primary hover:underline"
                >
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href={`https://${contributor.contact.website}`}
                  target="_blank"
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              We thank {contributor.name} for their valuable contributions to
              our mission of promoting Sanatana Dharma.
            </p>
          </div>
        </div>
      </main>
...
export const metadata = {
  ...
  description:
    "Learn about our expert contributors who help preserve and share Sanatana Dharma through shloka education.",
};
